...
const Hero = () => {
  ...
  return (
    <section 
      ref={targetRef}
      className="relative h-screen w-full overflow-hidden bg-gradient-to-br from-[#0f0c29] via-[#2a0845] to-[#4a00e0]"
    >
      {/* Animated particles */}
      ...
      <motion.div 
        ...
        className="w-full h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center mt-20"
      >
        <motion.div
